...
class GeneralSettingController extends Controller
{
    ...
    public function generalUpdate(Request $request)
    {
        ...
        if ($general->app_video == null) {
            $appVideoValidation = ['required', new FileTypeValidate(['mp4', 'mov', 'ogg', 'gt'])];
        }
        ...
        $request->validate([
            ...
            'max_image_size'        => 'required|integer|gte:1',
            'max_photo_count'       => 'required|integer|gte:1',
        ]);
        ...
        $general->max_image_size        = $request->max_image_size;
        $general->max_photo_count       = $request->max_photo_count;
        $general->save();
