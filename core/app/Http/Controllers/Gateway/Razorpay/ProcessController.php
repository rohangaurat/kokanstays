...
class ProcessController extends Controller
{
    ...
    public static function process($deposit)
    {
        ...
        $val['image'] = siteLogo();
        $val['prefill.name'] = currentAuth()['user']->firstname . ' ' . currentAuth()['user']->lastname;
        $val['prefill.email'] = currentAuth()['user']->email;
        $val['prefill.contact'] = currentAuth()['user']->mobileNumber;
