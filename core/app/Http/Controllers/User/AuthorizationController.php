...
class AuthorizationController extends Controller
{
    ...
    {
        return (!$user->ver_code_send_at) ? false : (($user->ver_code_send_at->addMinutes($addMin) < Carbon::now()) ? false : true);
    }
    ...
    public function authorizeForm()
    {
        ...
        return view('Template::user.auth.authorization.' . $type, compact('user', 'pageTitle', 'user'));
    }
    ...
    public function emailVerification(Request $request)
    {
        ...
        if ($user->ver_code == $request->code) {
            ...
            return $redirection ? $redirection : to_route('user.booking.history');
        }
