        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">@lang('Withdraw') (@lang('Balance'): <span class="fw-bold text--info">{{ showAmount(authOwner()->balance) }}</span>)</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('owner.withdraw.money') }}" method="post" class="withdraw-form">
                        @csrf
