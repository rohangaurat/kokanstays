                ...
                <form action="{{ route('owner.password.verify.code') }}" method="POST" class="login-form w-100">
                    ...
                    <div class="code-box-wrapper d-flex w-100">
                        <div class="form-group mb-3 flex-fill">
                            <label class="required">@lang('Verification Code')</label>
                    ...
                    <button type="submit" class="btn cmn-btn w-100 mt-2">@lang('Submit')</button>
                    <div class="d-flex flex-wrap justify-content-between mt-3">
                        <a href="{{ route('owner.password.reset') }}" class="forget-text">
...
@push('style')
    <link rel="stylesheet" href="{{ asset('assets/owner/css/verification_code.css') }}">
@endpush
