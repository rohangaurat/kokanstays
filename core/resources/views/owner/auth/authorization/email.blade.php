        ...
        <div class="container custom-container d-flex justify-content-center">
            <div class="login-area">
                <div class="text-center mb-3">
                    <h2 class="text-white mb-2">@lang('Verify Email Address')</h2>
                    <p class="text-white mb-2">@lang('A 6 digit verification code sent to your email address'): {{ showEmailAddress(authOwner()->email) }}</p>
                </div>
                <form action="{{ route('owner.verify.email') }}" class="login-form w-100" method="POST">
                    @csrf
                    ...
                    <div class="d-flex flex-wrap justify-content-between">
                        <a class="forget-text" href="{{ route('owner.send.verify.code', 'email') }}">@lang('Try again')</a>
                    </div>
