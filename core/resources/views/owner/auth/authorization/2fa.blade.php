        ...
        <div class="container custom-container d-flex justify-content-center">
            <div class="login-area">
                <div class="text-center mb-3">
                    <h2 class="text-white mb-2">@lang('2FA Verification')</h2>
                </div>
                <form action="{{ route('owner.go2fa.verify') }}" class="login-form w-100" method="POST">
                    @csrf
                    ...
                    <button class="btn cmn-btn w-100 mt-3" type="submit">@lang('Submit')</button>
                </form>
