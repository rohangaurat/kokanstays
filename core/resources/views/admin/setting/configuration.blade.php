                        ...
                        <ul class="list-group">
                            <li class="list-group-item d-flex flex-wrap flex-sm-nowrap gap-2 justify-content-between align-items-center">
                                <div>
                                    ...
                                    <p class="mb-0">
                                        <small>@lang('If you disable this module, no one can register as a user on this system.')</small>
                                    </p>
                                </div>
                            ...
                            <li class="list-group-item d-flex flex-wrap flex-sm-nowrap gap-2 justify-content-between align-items-center">
                                <div>
                                    <p class="fw-bold mb-0">@lang('Vendor Request')</p>
                                    <p class="mb-0">
                                        <small>@lang('If you enable this module, visitors can send request as vendor, otherwise can\'t.')</small>
                                    </p>
                                </div>
                                <div class="form-group">
                                    <input @if (gs('is_enable_owner_request')) checked @endif data-bs-toggle="toggle" data-height="35" data-off="@lang('Disable')" data-offstyle="-danger" data-on="@lang('Enable')" data-onstyle="-success" data-size="large" data-width="100%" name="is_enable_owner_request" type="checkbox">
                                </div>
                            </li>
                            <li class="list-group-item d-flex flex-wrap flex-sm-nowrap gap-2 justify-content-between align-items-center">
                                <div>
