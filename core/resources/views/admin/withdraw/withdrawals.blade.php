                            ...
                            <tbody>
                                @forelse($withdrawals as $withdraw)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="fw-bold">{{ $withdraw->owner->fullname }}</span>
                                            <br>
                                            <span class="small"> <a href="{{ appendQuery('search', @$withdraw->owner->email) }}">{{ $withdraw->owner->email }}</a> </span>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <a href="{{ route('admin.withdraw.data.details', $withdraw->id) }}" class="btn btn-sm btn-outline--primary">
