    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
            <div class="profile-wrapper">
                <h5 class="profile-wrapper__title">@lang('Checkout.com')</h5>
                <div class="card-wrapper mb-3"></div>
                <form role="form" id="payment-form" class="disableSubmission appPayment" method="{{ $data->method }}"
                    action="{{ $data->url }}">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="tel" class="form--control" name="cardExpiry" value="{{ old('cardExpiry') }}"
