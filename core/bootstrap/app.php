...
use App\Http\Middleware\CheckOwnerStatus;
use App\Http\Middleware\CheckStatus;
use App\Http\Middleware\Demo;
use App\Http\Middleware\MaintenanceMode;
use App\Http\Middleware\OwnerPermissionMiddleware;
use App\Http\Middleware\OwnerValidity;
...
return Application::configure(basePath: dirname(__DIR__))
    ->withRouting(
        ...
        using: function () {
            Route::namespace('App\Http\Controllers')->middleware([VugiChugi::mdNm()])->group(function () {
                ...
                Route::middleware(['web', 'maintenance'])->name('user.')->prefix('user')->group(base_path('routes/user.php'));
    ...
    ->withMiddleware(function (Middleware $middleware) {
        ...
        $middleware->alias([
            ...
            'check.owner.status'     => CheckOwnerStatus::class,
            'owner.permission'       => OwnerPermissionMiddleware::class,
            'owner.validity'         => OwnerValidity::class,
